...
class c0423 extends AbstractEvent
{
  ...
  public function PopulateEvents(string $prefix, bool $quiet = false)
  {
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 95,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-dinner'),
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 65,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-brunch'),
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 90,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-fri-buffet'),
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 239,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-attendee'),
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 0,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-vip'),
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 100,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-staff-coordinator'),
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 100,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-staff-onsite'),
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 100,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-staff-recruited'),
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 0,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-volunteer-2'),
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 0,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-volunteer-3'),
      'category' => ClawEvents::getCategoryId('volunteer'),
      'minShifts' => 3,
      'requiresCoupon' => false,
      'couponAccessGroups' => [],
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 1,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-volunteer-super'),
      'category' => ClawEvents::getCategoryId('volunteer'),
      'minShifts' => 6,
      'requiresCoupon' => true,
      'couponAccessGroups' => ['Super Users', 'Administrator', 'VolunteerMgmr'],
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 239,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-vendorcrew'),
    ...
    $this->AppendEvent(new ClawEvent((object)[
      ...
      'couponValue' => 100,
      'fee' => 0,
      'eventId' => ClawEvents::getEventIdByAlias($prefix . '-educator'),
    ...
    //   'isMainEvent' => true,
    //   'couponValue' => 0,
    //   'eventId' => ClawEvents::getEventIdByAlias($prefix . '-daypass-fri'),
    ...
    //   'isMainEvent' => true,
    //   'couponValue' => 0,
    //   'eventId' => ClawEvents::getEventIdByAlias($prefix . '-daypass-sat'),
    //   'category' => ClawEvents::getCategoryId('day-passes'),
    //   'minShifts' => 0,
    //   'requiresCoupon' => false,
    //   'couponAccessGroups' => []
    ...
    //   'isMainEvent' => true,
    //   'couponValue' => 0,
    //   'eventId' => ClawEvents::getEventIdByAlias($prefix . '-daypass-sun'),
    //   'category' => ClawEvents::getCategoryId('day-passes'),
    //   'minShifts' => 0,
    //   'requiresCoupon' => false,
    //   'couponAccessGroups' => []
