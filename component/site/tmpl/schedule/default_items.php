...
<div class="row row-striped g-0">
  <div class="col-9 col-lg-10 row">
    <div class="col-lg-2 pt-lg-2 pb-lg-2 mt-2 mb-2 font-weight-bold tight">Time</div>
    <div class="col-lg-8 pt-lg-2 pb-lg-2 mt-0 mt-lg-1 mb-0 mb-lg-1 font-weight-bold tight">Event</div>
    <div class="col-lg-2 pt-lg-2 pb-lg-2 mt-0 mt-lg-1 mb-2 mb-lg-1 font-weight-bold tight <?= $locationView ?>">Location</div>
  </div>
...
foreach ($this->items as $item):
  $stime = Helpers::formatDateTime($item->datetime_start);
  $etime = Helpers::formatDateTime($item->datetime_end);
  ...
  if (count(array_intersect($item->fee_event, ['preorder', 'dooronly'])) > 0) {
    if ($event_id != 0) {
  ...
  if (count(array_intersect($item->fee_event, ['door', 'dooronly'])) > 0) {
