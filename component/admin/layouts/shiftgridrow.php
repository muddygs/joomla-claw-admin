...
/* COPIED FROM
/layouts/joomla/form/field/subform/repeatable-table.php and repearable-table directory content
upon rename, the repeatable-table directory is renamed to match the name of the custom
layout (e.g., xxx.php with a directory called xxx)
*/
...
else
{
	foreach ($tmpl->getGroup('') as $field) {
		$widthAttribute = '';
		if (($col = $field->getAttribute('col')) != null )
		{
			$w = (int)$col ? (int)$col / 12 * 100 : 1/12*100;
			$widthAttribute = " style=\"width:$w%\"";
		}
		$table_head .= '<th scope="col"' . $widthAttribute . '>' . strip_tags($field->label);
