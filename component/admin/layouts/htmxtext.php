 ...
 */
 ...
 // NOTE: COPIED FROM layouts/joomla/form/field/text.php@5.1.0
...
$htmx = new class {
    use \ClawCorp\Component\Claw\Administrator\Field\HtmxFieldTrait;
};
 ...
 */
// TODO: adds HTMx attributes here
...
$htmxAttrs = $htmx->getHtmxClassProperties();
foreach ( $htmxAttrs AS $attr ) {
    if ( isset($$attr) && $$attr != null ) $attributes[] = str_replace('_', '-', $attr).'="'. $$attr .'"';
}
